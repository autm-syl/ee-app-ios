...
//        let filePath = Bundle.url(forResource: "rich_editor", withExtension: "html")
        let string = Bundle.main.path(forResource: "rich_editor", ofType: "html")
        let filePathUrl = URL(fileURLWithPath: string!)
        
        webView.loadFileURL(filePathUrl, allowingReadAccessTo: filePathUrl.deletingLastPathComponent())
