...
//  ChichBong
//
//  Created by Sylvanas on 4/28/21.
//
...
//            tableView = UITableView(frame: CGRect.zero)
    ...
    func filter(forceShowAll addAll: Bool) {
        clearResults()
...
open class SearchTextFieldItem {
    ...
    public var sublist: [String]?
    
    public init(title: String, subtitle: String?, image: UIImage?, sublist:[String], id:Int) {
        self.title = title
