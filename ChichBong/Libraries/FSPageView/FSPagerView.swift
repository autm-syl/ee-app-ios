...
public protocol FSPagerViewDelegate: NSObjectProtocol {
    ...
    optional func pagerView(_ pagerView: FSPagerView, willDisplay cell: FSQuestViewCell, forItemAt index: Int)
    ...
    optional func pagerView(_ pagerView: FSPagerView, didEndDisplaying cell: FSQuestViewCell, forItemAt index: Int)
...
open class FSPagerView: UIView,UICollectionViewDataSource,UICollectionViewDelegate {
    ...
    public func collectionView(_ collectionView: UICollectionView, willDisplay cell: UICollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        let index = indexPath.item % self.numberOfItems
        function(self,cell as! FSQuestViewCell,index)
    }
...
//        self.collectionView.register(UINib(nibName: identifier, bundle: .main), forCellWithReuseIdentifier: identifier)
        self.collectionView.register(UINib.init(nibName: "FSQuestViewCell", bundle: Bundle(for: FSQuestViewCell.self)), forCellWithReuseIdentifier: "FSQuestViewCell");
    }
    
    /// Register a nib file for use in creating new pager view cells.
    ///
    /// - Parameters:
    ///   - nib: The nib object containing the cell object. The nib file must contain only one top-level object and that object must be of the type FSQuestViewCell.
...
//        self.collectionView.register(UINib(nibName: identifier, bundle: .main), forCellWithReuseIdentifier: identifier)
    ...
    /// - Returns: A valid FSQuestViewCell object.
    @objc(dequeueReusableCellWithReuseIdentifier:atIndex:)
    open func dequeueReusableCell(withReuseIdentifier identifier: String, at index: Int) -> FSQuestViewCell {
        ...
        guard cell.isKind(of: FSQuestViewCell.self) else {
            fatalError("Cell class must be subclass of FSQuestViewCell")
        }
        return cell as! FSQuestViewCell
    }
    ...
    @objc(indexForCell:)
    open func index(for cell: FSQuestViewCell) -> Int {
    ...
    open func cellForItem(at index: Int) -> FSQuestViewCell? {
        let indexPath = self.nearbyIndexPath(for: index)
        return self.collectionView.cellForItem(at: indexPath) as? FSQuestViewCell
    }
