...
public final class VKPINStyleShit: EntryViewStyle {
    ...
    public func onSetStyle(_ label: VKLabel) {
        ...
        layer.backgroundColor = #colorLiteral(red: 0.9564993978, green: 0.9645027518, blue: 0.9810040593, alpha: 1)
    }
